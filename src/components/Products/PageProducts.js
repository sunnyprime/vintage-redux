...
export default function PageProducts() {
    var {sorted,page,changePage} = React.useContext(ProductContext)
    // console.log(sorted[1]);
    
    if(sorted[page]){
    return <>
     <ProductList products={sorted[page]} /><br /><br />
     {sorted.length>1 && (
     <article className="pagination-buttons">
        ...
        return <h3 className="search-errors">
            {" "}
            unfortunately your search query did not return any products</h3>
    }
}
